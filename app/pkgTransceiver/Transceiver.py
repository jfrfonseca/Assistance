...
from cpnLibrary.Constants import PORT_API_REQUESTS,\
    PORT_DATA_REQUESTS
...
class Transceiver():
    ...
    def resetLog(self):
        self.LOG += "\n---------------- Assistance TRANSCEIVER service RE-STARTED at "\
    ...
    def __init__(self, Instance):
        ...
        self.apiRequestAntenna = AssistanceSocketServer(
            PORT_API_REQUESTS, Instance, APIRequestAntenna)
        self.dataAntenna = AssistanceSocketServer(
            PORT_DATA_REQUESTS, Instance, DataAntenna)
